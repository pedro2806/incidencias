...
<head>
    ...
    <script>try{if(localStorage.getItem('mess-theme')==='dark')document.documentElement.classList.add('theme-dark')}catch(e){}</script>
...
<body id="page-top">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <div class="row"> 
                                        ...
                                        <div class="col-sm-4">
                                            <center>
                                                <p class="fs-4"><b>Detalle incidencias</b></p>
                                            </center>
                                    </div>
                                    <hr>
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="tablaDetalleIncidencias" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Solicita</th>
                                                    <th>Responsable</th>                                                    
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            obtenerYRenderizarSolicitudes("DetalleIncidencias", "#tablaDetalleIncidencias tbody");

            aplicarEstiloDataTable('#tablaDetalleIncidencias', 1);
        });
    </script>
</html>