...
$id_usuario = isset($_POST['id_usuarioI']) ? $_POST['id_usuarioI'] : '';
$nombredelusuario = isset($_POST['nombredelusuarioI']) ? $_POST['nombredelusuarioI'] : '';
$noEmpleado = isset($_POST['noEmpleadoI']) ? $_POST['noEmpleadoI'] : '';
$rol = isset($_POST['rolI']) ? $_POST['rolI'] : '';
$usuario = isset($_POST['correoI']) ? $_POST['correoI'] : '';
