                                ...
                                <!-- Card Body -->
                                    <div class = "card-body">
                                            <div class = "row">
                                                ...
                                                <div class = "col-xl-4">
                                                <center><p class="fs-4"><b>SOLICITUD DE INCIDENCIAS</b></p></center>
                                                </div>                                            
                                                <div class = "col-xl-4" style = "text-align: center">
        ...
        function empleadoSolicita(){
            ...
            let cookieNoEmpleado = getCookie('noEmpleado');
                $.ajax({
                    ...
                    method: 'GET',
                    dataType: 'json',
                    data:{opcion,cookieRol,cookieNoEmpleado},
        ...
        function generarSolicitud(){
            ...
            if(opIncidencia == '' || opIncidencia == null){
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    dataType: 'json',
                    data:{opIncidencia, notas, comentarios, solicita, cuantos, accion, periodos},
                    success: function(data) {
                        Swal.fire({
